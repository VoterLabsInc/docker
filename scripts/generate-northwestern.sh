...
cat >../projects/united-states-northwestern/pelias.json <<EOF
    {
        "logger": {
            "level": "info",
            "timestamp": false
        ...
        "imports": {
            ...
            "geonames": {
            "datapath": "/home/$USER/northwestern/geonames",
            "countryCode": "US"
            },
            "openstreetmap": {
            "download": [
                {"sourceURL": "https://download.geofabrik.de/north-america/us/idaho-latest.osm.pbf"},
                ...
                {"sourceURL": "https://download.geofabrik.de/north-america/us/wyoming-latest.osm.pbf"}
            ],
            "leveldbpath": "/tmp",
            "datapath": "/home/$USER/northwestern/openstreetmap",
            "import": [
                {"filename": "idaho-latest.osm.pbf"},
                {"filename": "montana-latest.osm.pbf"},
                {"filename": "oregon-latest.osm.pbf"},
                {"filename": "washington-latest.osm.pbf"},
                {"filename": "wyoming-latest.osm.pbf"}
            ]
            },
            "openaddresses": {
            "datapath": "/home/$USER/northwestern/openaddresses",
            "files": [
                "us/ca/alameda.csv",
                "us/ca/amador.csv",
                "us/ca/berkeley.csv",
                ...
                "us/id/blaine.csv",
                "us/id/bonner.csv",
                "us/id/bonneville.csv",
                "us/id/canyon.csv",
                "us/id/city_of_boise.csv",
                "us/id/clearwater.csv",
                "us/id/custer.csv",
                "us/id/fremont.csv",
                "us/id/jefferson.csv",
                "us/id/kootenai.csv",
                ...
                "us/id/madison.csv",
                "us/id/nez_perce.csv",
                "us/id/post_falls.csv",
                "us/id/teton.csv",
                "us/wy/albany.csv",
                "us/wy/campbell.csv",
                "us/wy/carbon.csv",
                "us/wy/city_of_gillette.csv",
                "us/wy/city_of_sundance.csv",
                "us/wy/city_of_wright.csv",
                "us/wy/converse.csv",
                "us/wy/crook.csv",
                "us/wy/fremont.csv",
                "us/wy/goshen.csv",
                "us/wy/hot_springs.csv",
                "us/wy/laramie.csv",
                "us/wy/lincoln.csv",
                "us/wy/natrona.csv",
                "us/wy/park.csv",
            ...
            "polyline": {
            "datapath": "/home/$USER/northwestern/polylines",
            "files": [ "extract.0sv" ]
            },
            "whosonfirst": {
            "datapath": "/home/$USER/northwestern/whosonfirst",
            ...
            "download": {
                "tiger": {
                "datapath": "/home/$USER/northwestern/tiger",
                "states": [
